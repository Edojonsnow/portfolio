...
export const DesktopSidebar = ({ className, children, ...props }) => {
  ...
  return (
    <>
      <motion.div
        className={cn(
          "h-full px-4 pt-20 hidden  md:flex md:flex-col bg-neutral-100 dark:bg-neutral-800 w-[200px] flex-shrink-0",
          className
        )}
        animate={{
...
export const MobileSidebar = ({ className, children, ...props }) => {
  ...
  return (
    <>
      <div
        className={cn(
          "h-10 px-4 py-4 flex flex-row md:hidden  items-center justify-between bg-purple-600 dark:bg-neutral-800 w-full"
        )}
        {...props}
      >
...
export const SidebarLink = ({ link, className, ...props }) => {
  ...
  return (
    <Link
      href={link.href}
      className={cn(
        "flex items-center sidebarlink  gap-2   group/sidebar py-2",
        className
      )}
      {...props}
    >

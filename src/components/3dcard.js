...
export function ThreeDCardDemo(props) {
  return (
    <CardContainer className="inter-var mobile-card-shadow  rounded-t-3xl w-[300px] lg:w-auto mx-auto lg:mx-0   p-3 ">
      <CardBody className=" hover:shadow flex flex-col lg:flex-row relative group/card  dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-full h-fit rounded-xl  lg:p-3   ">
